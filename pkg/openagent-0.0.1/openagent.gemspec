...
Gem::Specification.new do |s|
  ...
  s.extra_rdoc_files = ["README", "lib/openagent.rb", "lib/openagent/messages/header.rb", "lib/openagent/messages/sif_register.rb"]
  s.files = ["README", "Rakefile", "lib/openagent.rb", "lib/openagent/messages/header.rb", "lib/openagent/messages/sif_register.rb", "Manifest", "openagent.gemspec"]
